...
@Composable
fun ApplicationTapBar(title : String, drawerState: DrawerState,navController: NavController,isSearch:Boolean,closeSearch : ()->Unit,openSearch : ()->Unit, modifier: Modifier){
        ...
        title = {
            if (isSearch){
                TextField(
                    ...
                    trailingIcon = {
                        Image(
                            painter = painterResource(id = R.drawable.green_search_ic),
...
fun ApplicationTabBarPreview(){
    ...
    var isSearch = true
    ApplicationTapBar(title = "Home", drawerState = DrawerState(DrawerValue.Closed),navController,isSearch, closeSearch = {isSearch= false}, openSearch = {isSearch=true}, modifier = Modifier)
}